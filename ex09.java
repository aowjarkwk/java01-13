...
public class ex09 {
	...
	public static void main(String[] args) {
	    ...
	    // nextInt() : 문자열을 입력받아서 정수(int)로 반환
	    // nextFloat() : 문자열을 입력받아서 실수(float)로 반환
		
	    // charAt(index) : 문자열에서 index(0부터 시작함)에 해당하는 문자 한글자(char)만 가져옴.
		//               : char형으로 반환
		...
		scan.nextLine(); // next()에 가지고 있던 데이터를 지워줌.
